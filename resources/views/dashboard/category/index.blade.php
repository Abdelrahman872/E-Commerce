...
<div class="container-fluid">
    <div class="col-12">
        ...
        <form class="d-sm-inline-block form-inline" action="{{ route('categories.search') }}" method="GET">
            <div class="input-group">
                <input name="query" type="text" class="form-control bg-light border-0 small"
...
<?php $id=0; ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#del{{$category->id}}">
                        حذف
                      </button>
