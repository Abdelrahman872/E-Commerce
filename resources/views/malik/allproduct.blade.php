...
<div class="container-fluid bg-breadcrumb headre2">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h3 class="text-light display-3 wow fadeInDown" data-wow-delay="0.1s">Products</h1>
